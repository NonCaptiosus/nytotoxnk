  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="prose prose-lg max-w-none dark:prose-invert">
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4 text-primary dark:text-text-dark font-serif">Connect With Me</h2>
        ...
        <div className="flex space-x-4">
          <a
            ...
            className="flex items-center space-x-3 text-secondary dark:text-accent-dark hover:text-primary dark:hover:text-text-dark transition-colors"
          >
